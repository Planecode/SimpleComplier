...
class List
{
    ...
    void generate_init_assign(node *nowNode, string type)
    {
        ...
        {
            int index = get_index(nowNode->cNode[0]);
            node *argv_list = nowNode->cNode[1]->cNode[0];
